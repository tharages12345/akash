(function(namespace, $) {
  ...
  p._enableEvents = function() {
    ...
    $('[data-toggle="menubar-h"]').on('click', function(e) {
      o._handleHMenuToggleClick(e);
    });
  ...
  // MENU TOGGLER
  // =========================================================================
  p._handleHMenuToggleClick = function(e) {
    if (materialadmin.App.isBreakpoint('xs')) {
      $('body').toggleClass('menubar-h-open');
    }
