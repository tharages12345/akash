  ...
  j = function(d) {
    ...
    e.prototype = {
      ...
      _fnConstruct: function(a) {
        ...
        this.s.dt.aoDrawCallback.push({ fn: function() { b._fnDrawCallback.call(b) }, sName: "ColVis" });
        ...
        for (f = c.length; b < f; b++) {
          a: {
            for (var g = c[b].aiColumns, h = 0, e = g.length; h < e; h++)
              if (!1 === a[g[h]].bVisible) { g = !1; break a }
            g = !0
          }
          ...
          d("input", this.dom.groupButtons[b]).prop("indeterminate", !1);
            ...
            a: {
              ...
              for (e = g.length; h < e; h++)
                if (!0 === a[g[h]].bVisible) { g = !1; break a }
              g = !0
            }
      ...
      _fnDomColumnButton: function(a) {
        ...
        return d("<li " + (f.bJUI ? 'class="ui-button ui-state-default"' : "") + '><label><input type="checkbox" class="colvis_switch" /><span>' + c + "</span></label></li>").click(function(c) {
      ...
      _fnDomCollection: function() { return d("<ul />", { "class": !this.s.dt.bJUI ? "ColVis_collection" : "ColVis_collection ui-buttonset ui-buttonset-multi" }).css({ display: "none", opacity: 0, position: !this.s.bCssPosition ? "absolute" : "" })[0] },
      ...
      _fnDomBackground: function() {
        var a = this,
          b = d("<div></div>").addClass("ColVis_collectionBackground").css("opacity", 0).click(function() { a._fnCollectionHide.call(a, null, null) });
      ...
      _fnCollectionHide: function() {
        var a = this;
        !this.s.hidden && null !== this.dom.collection && (this.s.hidden = !0, d(this.dom.collection).animate({ opacity: 0 }, a.s.iOverlayFade, function() { this.style.display = "none" }), d(this.dom.background).animate({ opacity: 0 },
          a.s.iOverlayFade,
          function() {
    ...
    e.fnRebuild = function(a) { var b = null; "undefined" != typeof a && (b = a.fnSettings().nTable); for (var c = 0, d = e.aInstances.length; c < d; c++)("undefined" == typeof a || b == e.aInstances[c].s.dt.nTable) && e.aInstances[c].fnRebuild() };
